        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item text-white d-flex flex justify-content-start align-items-center">
                    ...
                    <a class="nav-link ms-2" href="?page=users">Usuarios</a>
                </li>
                ...
                <li class="nav-item text-white d-flex flex justify-content-start align-items-center">
                    ...
                    <a class="nav-link ms-2" href="database/processUser/processLogout.php">Sair</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container-fluid pt-3 pb-3 ps-4 pe-4 h-100">
    <?php
        ...
        switch ($pageRequest) {
        case 'historico':
            include("pages/adm/ADMhome.php");
            break;
        case 'users':
            include("pages/adm/ADMusuario.php");
            break;
        case 'logs':
            include("pages/adm/ADMlog.php");
            break;
        }
    ?>
</div>